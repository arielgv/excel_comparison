...
# Search for the data from the 'quantity' column within the plain text PDF
missing_values = []
...
if not missing_values:
    print('All values from the quantity column are present in the PDF')
else:
    print(f'The following values from the quantity column are not present in the PDF: {missing_values}')